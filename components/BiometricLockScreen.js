...
const makeStyles = (c) => StyleSheet.create({
  ...
  title: { ...c.type.display, color: c.text, marginBottom: 6 },
  subtitle: { ...c.type.body, color: c.textMuted, marginBottom: c.spacing.xl },
  error: { ...c.type.bodySm, color: c.error, textAlign: 'center', marginBottom: 20 },
  unlockBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
    backgroundColor: c.primary,
    paddingHorizontal: c.spacing.xl,
    paddingVertical: 14,
    borderRadius: c.radius.lg,
  },
  logoutBtn: { backgroundColor: c.error },
  unlockBtnText: { ...c.type.heading, fontFamily: c.fonts.bodySemiBold, color: c.onPrimary },
});
